...
6. [ ] `04` Renderizar feed com dados reais da API
...
Motivo: e a ultima `priority-high` de produto ainda pendente/parcial antes da migracao para TypeScript. O feed basico ja existe, mas ainda falta acabamento de estados, UX e comportamento.
